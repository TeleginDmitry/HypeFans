...
import styles from './PostCommentFormMedias.module.scss'

interface IPostCommentFormMedias {
  setMedias: React.Dispatch<React.SetStateAction<IResponseViewMedia[]>>
  medias: IResponseViewMedia[]
}

const PostCommentFormMedias = ({
  setMedias,
  medias
}: IPostCommentFormMedias) => {
...
export default PostCommentFormMedias
